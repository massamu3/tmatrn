@extends('system-mgmt.section.base')
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('section.create') }}">Add new section</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    ...
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                ...
                <tr role="row" class="odd">
                  <td>{{ $section->name }}</td>
                    ...
                    <form class="row" method="POST" action="{{ route('section.destroy', ['id' => $section->id]) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('section.edit', ['id' => $section->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                        Update
                        </a>
      ...
      <div class="row">
        <div class="col-sm-5">
          <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1 to {{count($sections)}} of {{count($sections)}} entries</div>
        </div>
        <div class="col-sm-7">
